...
# Stigler Diet: Find the most inexpensive way to fulfill basic nutiritional needs given a set of foods and nutritional requirements
# In this example we will be solving the Stigler Diet problem using the Glop linear solver
...
solver = pywraplp.Solver('StiglerDietExample', pywraplp.Solver.GLOP_LINEAR_PROGRAMMING)

# Declare an array to hold our variables.
# foods[i] represents the cost for commodity "i"
...
for i, nutrient in enumerate(nutrients):
    ...
    for j, item in enumerate(data):
        # Use i+3 because the nutrient data begins on the 4th column
...
# The objective function is the total cost of the food, which is the sum of the variables foods[i]
